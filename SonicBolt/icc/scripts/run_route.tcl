source [file join $script_dir common_optimization_settings_icc.tcl]
source [file join $script_dir common_placement_settings.tcl]
source [file join $script_dir common_post_cts_timing_settings.tcl]
source [file join $script_dir common_route_si_settings_zrt_icc.tcl]
