/*
    ...
    Filename:      S018V3EBCDSP_X8Y4D96_PR.v
    ...
    Configuration: -instname S018V3EBCDSP_X8Y4D96_PR -rows 8 -bits 96 -mux 4 
    Redundancy: Off
    Bit-Write: Off
*/
...
module S018V3EBCDSP_X8Y4D96_PR(
                          Q,
			  CLK,
			  CEN,
			  WEN,
  ...
  specify
    ...
    $period(posedge CLK,3.497,CLK_CYC_flag);
    $width(posedge CLK,1.049,0,CLK_H_flag);
    $width(negedge CLK,1.049,0,CLK_L_flag);
