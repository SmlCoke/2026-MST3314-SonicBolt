/*
    ...
    Filename:      S018V3EBCDSP_X8Y4D112_PR.v
    ...
    Configuration: -instname S018V3EBCDSP_X8Y4D112_PR -rows 8 -bits 112 -mux 4 
    Redundancy: Off
    Bit-Write: Off
*/
...
module S018V3EBCDSP_X8Y4D112_PR(
                          Q,
			  CLK,
			  CEN,
			  WEN,
  ...
  specify
    ...
    $period(posedge CLK,3.553,CLK_CYC_flag);
    $width(posedge CLK,1.066,0,CLK_H_flag);
    $width(negedge CLK,1.066,0,CLK_L_flag);
