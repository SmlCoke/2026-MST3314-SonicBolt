/*
    ...
    Filename:      S018V3EBCDSP_X20Y4D64_PR.v
    ...
    Configuration: -instname S018V3EBCDSP_X20Y4D64_PR -rows 20 -bits 64 -mux 4 
    Redundancy: Off
    Bit-Write: Off
*/
...
module S018V3EBCDSP_X20Y4D64_PR(
                          Q,
			  CLK,
			  CEN,
			  WEN,
  ...
  specify
    ...
    $period(posedge CLK,3.400,CLK_CYC_flag);
    $width(posedge CLK,1.020,0,CLK_H_flag);
    $width(negedge CLK,1.020,0,CLK_L_flag);
