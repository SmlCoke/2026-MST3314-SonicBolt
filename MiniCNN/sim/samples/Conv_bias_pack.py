...
bias = read_bias(os.path.join(current_path, 'Param', 'Param_Conv_Bias.txt'))

print(len(bias))
print(bias[0])

# write_bias_hex(bias, os.path.join(current_path, '_Param_Conv_Bias_hex.txt'))
arrange_bias_hex(bias, os.path.join(current_path, 'Conv_Bias_arranged.txt'))
